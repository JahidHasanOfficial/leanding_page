...
@section('title', 'অর্ডার সফল হয়েছে')

@section('content')
<div class="max-w-2xl mx-auto my-12 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-white/10 rounded-3xl p-8 sm:p-12 shadow-xl dark:shadow-2xl text-center transition-all duration-300">
